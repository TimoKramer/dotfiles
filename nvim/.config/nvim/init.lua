...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').add {
        ...
        { '<leader>gc', group = '[G]it [T]oggle', mode = { 'n', 'v' } },
        { '<leader>l', group = '[L]og' },
        { '<leader>s', group = '[S]repl' },
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- K for hover documentation is built-in since nvim 0.11
      ...
      local servers = {
        clojure_lsp = {
          autostart = true,
          root_markers = { 'workspace.edn', 'deps.edn', 'project.clj', 'bb.edn', '.git' },
        },
        clangd = {
      ...
      -- Configure and enable each LSP server using the native vim.lsp API (nvim 0.11+)
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      -- mini.comment removed: gc commenting is built-in since nvim 0.10
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      local parsers = { 'bash', 'c', 'clojure', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'python', 'query', 'vim', 'vimdoc', 'yaml' }
